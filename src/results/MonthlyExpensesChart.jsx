...
import { formatInDollars, getSumOfArrayProperty } from '../shared/utilities';
...
const CustomTooltip = React.memo(
  ...
  (prevProps, nextProps) => {
    const prevValuesSum = getSumOfArrayProperty(prevProps.payload, 'value');
    const nextValuesSum = getSumOfArrayProperty(nextProps.payload, 'value');
    return prevValuesSum === nextValuesSum;
  },
);

// eslint-disable-next-line react/prop-types
const CustomLabel = React.memo(
  ({ viewBox, value1, value2 }) => {
    // eslint-disable-next-line react/prop-types
    const { cx, cy } = viewBox;
    return (
      <>
